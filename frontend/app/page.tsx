...
const slideImages = [
  { id: 1, url: "/images/one1.jpg", title: "PSTU Main Campus", description: "..." },
  { id: 2, url: "/images/two1.jpg", title: "Advanced Laboratories", description: "..." },
  { id: 3, url: "/images/three1.jpg", title: "Academic Excellence", description: "..." },
  { id: 4, url: "/images/four.jpeg", title: "Student Life", description: "..." },
]
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg mb-12 leading-relaxed" style={{ color: "#666" }}>
              The ICT Cell of Patuakhali Science and Technology University provides comprehensive technology solutions
