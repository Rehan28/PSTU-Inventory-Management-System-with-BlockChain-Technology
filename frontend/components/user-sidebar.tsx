...
import { LayoutDashboard, Truck, Package, ArrowUp, Trash2, LogOut, ArrowDown } from "lucide-react"
...
const menuItems = [
  ...
  {
    title: "Create Item",
    href: "/user/CreateItem",
    icon: Package,
  },
  {
    title: "Stock In Request",
    href: "/user/stockInRequest",
    icon: ArrowUp,
  },
  {
    title: "My StockOut",
