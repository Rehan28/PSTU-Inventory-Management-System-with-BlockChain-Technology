...
const menuItems = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { title: "Current Stock", href: "/admin/stock-in/current-stock" }
    ],
  },
  {
    title: "Stock Out",
    ...
    submenu: [
      ...
      { title: "Current Stock Out", href: "/admin/stock-out/current-stock" }
    ],
  },
  {
    title: "Dead Stock",
  ...
  },
  {
    ...
    submenu: [
      ...
      //{ title: "Supplier-wise", href: "/admin/reports/supplier" },
  ...
  },
  {
    ...
    icon: Bell,
    submenu: [
      { title: "Stock In Requests", href: "/admin/requests" },
      { title: "Dead Stock Requests", href: "/admin/deadRequests" },
    ],
  },
  {
    title: "Block Chain Verification",
    icon: Bell,
    href: "/admin/block_chain",
  }
]
